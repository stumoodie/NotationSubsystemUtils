...
public abstract class ModelObject implements INdomModel {
	 ...
	 */
	public ModelObject(String id, String name, String asciiName) throws IllegalArgumentException{
		if(!id.matches("(_|[a-z]|[A-Z])(_|[a-z]|[A-Z]|[0-9])*")) throw new IllegalArgumentException("Invalid ID: "+id);
		if(name==null) throw new IllegalArgumentException("Name should not be null");
		if(asciiName==null) throw new IllegalArgumentException("ASCIIName should not be null");
		this.id = id;
		this.name = name;
	...
	/**
	 * Create object from id and visual element.
	 * @see #ModelObject(String, String, String)
	 * @param id object ID ("(_|[a-z]|[A-Z])(_|[a-z]|[A-Z]|[0-9])*")
 ...
 *
 * Revision 1.2  2008/07/07 08:46:50  nhanlon
 * interface changes
 *
