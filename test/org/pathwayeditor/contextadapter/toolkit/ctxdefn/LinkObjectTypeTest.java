...
public class LinkObjectTypeTest {
	...
	private ILinkAttributeDefaults linkAttributeDefaults = mockery
			.mock(ILinkAttributeDefaults.class);
	private ILinkTerminusDefaults linkTerminusDefinition = mockery
			.mock(ILinkTerminusDefaults.class);
	private ILinkTerminusDefaults linkTerminusDefinition1 = mockery
			.mock(ILinkTerminusDefaults.class);
	...
	public void testLinkAttributeDefaultsNullThrowsException() {
		lot = new LinkObjectType(null, positiveId, description, name,
				iNotationSyntaxService, linkTerminusDefinition,
				linkTerminusDefinition1);
	}

	@Test
	public void testLinkAttributeDefaultsNotNullValid() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId,
				description, name, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
	...
	public void testUniqueIdNotPositiveThrowsException() {
		lot = new LinkObjectType(linkAttributeDefaults, negativeId,
				description, name, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
	}
	...
	public void testDescriptionEmptyStringValid() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId,
				emptyDescription, name, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
	...
	public void testNullDescriptionThrowsException() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId, null, name,
				iNotationSyntaxService, linkTerminusDefinition,
				linkTerminusDefinition1);
	}
	...
	public void testNameNullThrowsException() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId,
				emptyDescription, null, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
	}
	...
	public void testNameEmptyThrowsException() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId,
				emptyDescription, emptyName, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
	}
	...
	public void testNullNotationSyntaxServiceThrowsException() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId,
				emptyDescription, name, null, linkTerminusDefinition,
				linkTerminusDefinition1);
	}
	...
	public void testHashCodeUsesSyntaxService() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId,
				emptyDescription, name, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
		ILinkObjectType sameSyntaxService = new LinkObjectType(
				linkAttributeDefaults, positiveId, emptyDescription, name,
				iNotationSyntaxService, linkTerminusDefinition,
				linkTerminusDefinition1);
		INotationSyntaxService differentService = mockery
				.mock(INotationSyntaxService.class);
		ILinkObjectType differentSyntaxService = new LinkObjectType(
				linkAttributeDefaults, positiveId, emptyDescription, name,
				differentService, linkTerminusDefinition,
				linkTerminusDefinition1);
	...
	public void testHashCodeUsesUniqueId() {
		lot = new LinkObjectType(linkAttributeDefaults, positiveId,
				emptyDescription, name, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
		ILinkObjectType sameId = new LinkObjectType(linkAttributeDefaults,
				positiveId, emptyDescription, name, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
		ILinkObjectType differentId = new LinkObjectType(linkAttributeDefaults,
				positiveId + 1, emptyDescription, name, iNotationSyntaxService,
				linkTerminusDefinition, linkTerminusDefinition1);
